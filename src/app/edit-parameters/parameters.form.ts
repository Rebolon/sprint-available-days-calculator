...
export class ParametersForm extends FormGroup {
  readonly nbWeeksForOneSprint = this.get('nbWeeksForOneSprint') as FormControl<number>;
  readonly marginRate = this.get('marginRate') as FormControl<number>;
  readonly velocityRateForNewComer = this.get('velocityRateForNewComer') as FormControl<number>;
